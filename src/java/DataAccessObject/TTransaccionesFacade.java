    ...
    public List<TTransacciones> actualizarTablaTransacciones(Date fechaInicio, Date fechaFinal, String idModulo, Long idSede, Long cedulaEnSession, String nombrePermiso) {
        try {
            ...
            if (idModulo == null && idSede == null) {
                query2 = "SELECT  a FROM TTransacciones AS a , TPermisos as b  WHERE  (a.fechaTransaccion BETWEEN ?1 and ?2)  and (b.idModulo=a.idModulo.idModulo) and (a.idSede.idCiudad.idciudad=b.idCiudad) and (b.documentoUsuario=?3) and (b.nombreControl=?4) and (a.valorRecibido > 0)";
                casee = 1;
            } else if (idModulo == null && idSede != null) {
                query2 = "SELECT  a FROM TTransacciones AS a , TPermisos as b  WHERE  (a.fechaTransaccion BETWEEN ?1 and ?2) and (b.documentoUsuario=?3) and (b.nombreControl=?4) and (b.idModulo=a.idModulo.idModulo) and (a.idSede.idCiudad.idciudad=?5) and (a.valorRecibido > 0)";
                casee = 2;
            } else if (idModulo != null && idSede == null) {
                query2 = "SELECT  a FROM TTransacciones AS a , TPermisos as b  WHERE  (a.fechaTransaccion BETWEEN ?1 and ?2) and (b.documentoUsuario=?3) and (b.nombreControl=?4) and (a.idModulo.idModulo=?5) and (a.idSede.idCiudad.idciudad=b.idCiudad) and (a.valorRecibido > 0)";
                casee = 3;
            } else if (idModulo != null && idSede != null) {
                query2 = "SELECT DISTINCT  a FROM TTransacciones AS a , TPermisos as b  WHERE  (a.fechaTransaccion BETWEEN ?1 and ?2) and (b.documentoUsuario=?3) and (b.nombreControl=?4) and (a.idModulo.idModulo=?5) and (a.idSede.idCiudad.idciudad=?6) and (a.valorRecibido > 0)";
                casee = 4;
            }
